...
norms = colors.DivergingNorm(vmin=0,
                                vcenter=0.25,
                             vmax=0.5)
h = ax1.pcolormesh(data_lon,data_lat,data_variable_SM_IRR, cmap=cmap, rasterized=True, norm=norms)
cbar   = f.colorbar(h, ax=ax1, cmap=cmap,
                               spacing='uniform',
                               orientation='horizontal',
                               extend='max', shrink = 1, pad = 0, aspect = 50)
...
norms = colors.DivergingNorm(vmin=0,
                                vcenter=0.25,
                             vmax=0.5)
h = ax1.pcolormesh(data_lon,data_lat,data_variable_SM_DU, cmap=cmap, rasterized=True, norm=norms)
cbar   = f.colorbar(h, ax=ax1, cmap=cmap,
                               spacing='uniform',
                               orientation='horizontal',
                               extend='max', shrink = 1, pad = 0, aspect = 50)
