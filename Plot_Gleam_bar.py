...
csvframe = pd.read_csv("E:\Data_Evaluation\Data_for_evaluation\ET_GLEAM\\bias.csv",header=None)
csvframe1 = pd.read_csv("E:\Data_Evaluation\Data_for_evaluation\ET_GLEAM\\rmse.csv",header=None)
...
plt.legend(loc='best')
plt.title('Bias (Evapotranspiration)', fontsize=16)
plt.ylabel('Bias (mm/month)', fontsize=14)
...
plt.xticks([0.3, 1.3, 2.3, 3.3, 4.3, 5.3, 6.3], [r'GLO', r'WNA', r'NCA', r'MED', r'WCA', r'EAS', r'SAS'], fontsize=12)
plt.legend(loc='best')
plt.title('RMSE (Evapotranspiration)', fontsize=16)
plt.ylabel('RMSE (mm/month)', fontsize=14)
