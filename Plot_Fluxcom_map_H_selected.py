...
data_E_GLEAM = Data_from_nc('E:\Data_Evaluation\Data_for_evaluation\FLUXCOM\H.RS.EBC-ALL.MLM-ALL.METEO-NONE.720_360.monthly.2006-2015_remap_W_m2_timmean.nc')   #load the data
...
data_variable_E_GLEAM = data_E_GLEAM.load_variable('H')
data_variable_E_GLEAM = data_variable_E_GLEAM[0, :, :]
data_variable_E_GLEAM = data_variable_E_GLEAM[29 :, :]  #no Anrctatica



data_E_NOI = Data_from_nc('E:\Data_Evaluation\Data_for_evaluation\FLUXCOM\\NOI_FSH_monmean_timmean.nc')   #load the data
...
data_E_CTL = Data_from_nc('E:\Data_Evaluation\Data_for_evaluation\FLUXCOM\\CTL_FSH_monmean_timmean.nc')   #load the data
data_variable_E_CTL = data_E_CTL.load_variable('FSH')
...
data_E_IRR = Data_from_nc('E:\Data_Evaluation\Data_for_evaluation\FLUXCOM\\IRR_FSH_monmean_timmean.nc')   #load the data
...
data_E_DU = Data_from_nc('E:\Data_Evaluation\Data_for_evaluation\FLUXCOM\\DU_FSH_monmean_timmean.nc')   #load the data
data_variable_E_DU = data_E_DU.load_variable('FSH')
...
cbar.set_label('Sensible heat flux (W/$m^2$)',fontsize = 8)
