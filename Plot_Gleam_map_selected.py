...
data_E_GLEAM = Data_from_nc('E:\Data_Evaluation\Data_for_evaluation\ET_GLEAM\E_2006-2015_GLEAM_v3.5b_MO_regrid_mean.nc')   #load the data
...
data_variable_E_GLEAM = data_E_GLEAM.load_variable('E')
data_variable_E_GLEAM = data_variable_E_GLEAM.swapaxes(2,1)
data_variable_E_GLEAM = data_variable_E_GLEAM[0, :, :]
data_variable_E_GLEAM = data_variable_E_GLEAM[29 :, :]  #no Anrctatica



data_E_NOI = Data_from_nc('E:\Data_Evaluation\Data_for_evaluation\ET_GLEAM\\NOI_EFLX_LH_TOT_mm_mon_mean.nc')   #load the data
...
data_E_CTL = Data_from_nc('E:\Data_Evaluation\Data_for_evaluation\ET_GLEAM\\CTL_EFLX_LH_TOT_mm_mon_mean.nc')   #load the data
...
data_E_IRR = Data_from_nc('E:\Data_Evaluation\Data_for_evaluation\ET_GLEAM\\IRR_EFLX_LH_TOT_mm_mon_mean.nc')   #load the data
...
data_E_DU = Data_from_nc('E:\Data_Evaluation\Data_for_evaluation\ET_GLEAM\\DU_EFLX_LH_TOT_mm_mon_mean.nc')   #load the data
...
cbar.set_label('Evapotranspiration/month (mm)',fontsize = 8)
