...
data_E_NOI = Data_from_nc('D:\Tower_result\Global_simulations\\NOIRR\EFLX_LH_TOT.nc')   #load the data
...
data_E_NOI = Data_from_nc('D:\Tower_result\Global_simulations\\NOIRR\FSH.nc')   #load the data
...
data_E_NOI = Data_from_nc('D:\Tower_result\Global_simulations\\NOIRR\SWup.nc')   #load the data
...
data_E_NOI = Data_from_nc('D:\Tower_result\Global_simulations\\NOIRR\LWup.nc')   #load the data
...
plt.savefig('E:\Data_Evaluation\Data_for_evaluation\Irrigation_amount\Fig\\10.png')

f = plt.figure(figsize = (12, 8), dpi=1000)  # initiate the figure
set_plot_param()

data_E_NOI = Data_from_nc('D:\Tower_result\Global_simulations\\NOIRR\Qle.nc')   #load the data
...
data_E_NOI = Data_from_nc('D:\Tower_result\Global_simulations\\NOIRR\QVEGT.nc')   #load the data
...
data_E_NOI = Data_from_nc('D:\Tower_result\Global_simulations\\NOIRR\QRUNOFF.nc')   #load the data
...
data_E_NOI = Data_from_nc('D:\Tower_result\Global_simulations\\NOIRR\TOTSOILLIQ.nc')   #load the data
...
plt.savefig('E:\Data_Evaluation\Data_for_evaluation\Irrigation_amount\Fig\\11.png')