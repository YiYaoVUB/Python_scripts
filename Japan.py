...
np.savetxt("E:\Data_Evaluation\Data_for_evaluation\Irrigation_amount\Fig\Japan_Bias.csv", bias, delimiter=',')
np.savetxt("E:\Data_Evaluation\Data_for_evaluation\Irrigation_amount\Fig\Japan_Rmse.csv", rmse, delimiter=',')
