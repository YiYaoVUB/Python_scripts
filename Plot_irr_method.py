...
f = plt.figure(figsize = (12, 3.5), dpi=1000)  # initiate the figure
set_plot_param()
...
ax1.set_title('corn and wheat',loc='right',fontsize = 12)
...
plt.savefig('E:\Data_Evaluation\Data_for_evaluation\Irrigation_amount\Fig\\12.png')