...
for year in range(2009, 2011):
    ...
    for month in range(1, 13):
        str_month = str(month)
        if month < 10:
            strfile = 'D:\Forcing_tower\\Castellaro\\' + str_year + '-0' + str_month + '.nc'
        else:
            strfile = 'D:\Forcing_tower\\Castellaro\\' + str_year + '-' + str_month + '.nc'
        ...
        edgee[0] = 9.0625
        longxy[0, 0] = 8.7500
        edgen[0] = 45.117493472584800
        edges[0] = 44.647519582245380
        latixy[0, 0] = 44.882506527415090
