...
csvframe = pd.read_csv("E:\Data_Evaluation\Data_for_evaluation\FLUXCOM\\bias_sensible.csv",header=None)
csvframe1 = pd.read_csv("E:\Data_Evaluation\Data_for_evaluation\FLUXCOM\\rmse_sensible.csv",header=None)
...
plt.legend(loc='best')
plt.title('Bias (Sensible heat flux)', fontsize=16)
plt.ylabel('Bias (W/$m^2$)', fontsize=14)
...
plt.xticks([0.3, 1.3, 2.3, 3.3, 4.3, 5.3, 6.3], [r'GLO', r'WNA', r'NCA', r'MED', r'WCA', r'EAS', r'SAS'], fontsize=12)
plt.legend(loc='best')
plt.title('RMSE (Sensible heat flux)', fontsize=16)
plt.ylabel('RMSE (W/$m^2$)', fontsize=14)
