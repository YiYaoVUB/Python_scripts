...
for year in range(2001, 2014):
    ...
    for month in range(1, 13):
        str_month = str(month)
        if month < 10:
            strfile = 'D:\Forcing_tower\\NE3\\' + str_year + '-0' + str_month + '.nc'
        else:
            strfile = 'D:\Forcing_tower\\NE3\\' + str_year + '-' + str_month + '.nc'
        ...
        edgee[0] = 264.0625
        longxy[0, 0] = 263.7500
        edgen[0] = 41.3577023498694
        edges[0] = 40.88772845953
        latixy[0, 0] = 41.1227154046997
