...
pres = data_forc[:, 39] * 1000
sola = data_forc[:, 32]
prec = data_forc[:, 41] / 86400
long = data_forc[:, 34]
...
for year in range(2016, 2019):
    ...
    for month in range(1, 13):
        str_month = str(month)
        if month < 10:
            strfile = 'D:\Forcing_tower\\Cheorwon\\' + str_year + '-0' + str_month + '.nc'
        else:
            strfile = 'D:\Forcing_tower\\Cheorwon\\' + str_year + '-' + str_month + '.nc'
        ...
        edgee[0] = 127.8125
        longxy[0, 0] = 127.5000
        edgen[0] = 38.537859007832850
        edges[0] = 38.067885117493430
        latixy[0, 0] = 38.302872062663140
